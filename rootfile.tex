...
\maketitle
\begin{abstract}
En este trabajo se discuten los fundamentos de la acústica no lineal y
una de sus aplicaciones más relevantes: las bocinas direccionales. El
trabajo inicia discutiendo el análisis clásico de las ecuaciones de
onda de audio, continúa presentando los fundamentos del audio no
lineal hasta llegar a las ecuaciones de Westervelt, Burgers y
